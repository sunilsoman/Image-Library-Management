...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function SelectRadiobutton(radio) {
            ...
            document.getElementById("hdCheckRadio").value = "true";
        }
        ...
        function performCheck() {
            ...
            var rbtnlist = document.getElementsByTagName("input");
            for (i = 0; i < rbtnlist.length; i++) {
                if (rbtnlist[i].type == "radio" && rbtnlist[i].checked == true) {

                    return true;
                    
                }
            }
            alert('Select an Image to remove');
            return false;
        }
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button2" runat="server" Text="Remove" Width="102px" OnClick="Remove_Click" OnClientClick="performCheck()" ValidationGroup="CheckControls"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div>
            ...
            <asp:HiddenField ID ="hdCheckRadio" runat="server" Value="false" />
        </div>
    </form>
</body>
</html>
